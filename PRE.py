...
if st.session_state.step < len(journey) * 2:
   ...
   mapping = {
        # ผู้เฝ้าดู (Observant): ชอบสังเกต เข้าใจ และใคร่ครวญ
        ...
        "โลกที่เต็มไปด้วยความจริง": "ผู้เฝ้าดู",

        # นักเดินทาง (Explorer): ชอบการผจญภัย การค้นหา และไม่หยุดนิ่ง
        ...
        # ผู้รังสรรค์ (Creator): ชอบสร้างสรรค์ มีจินตนาการ และต้องการแสดงออก
        ...
        # นักรบเงา (Shadow Warrior): เข้มแข็ง กล้าหาญ และอาจเผชิญกับด้านมืดของตัวเอง
        ...
        "ยอมรับมันและทำความเข้าใจกับมัน": "นักรบเงา", # เพิ่มเติมเพื่อให้มีความเฉพาะเจาะจง

        # ผู้หลงลืม (Lost Soul): รู้สึกสับสน ไม่แน่ใจในตัวเอง และอาจกำลังค้นหาตัวตน
        ...
        "ฉันไม่แน่ใจว่าฉันอยู่ที่นี่ทำไม": "ผู้หลงลืม", # เพิ่มเติมความสับสน

        # ผู้ถือแสง (Light Bringer): มองโลกในแง่ดี มีความหวัง และต้องการนำทาง
        "ความหวังที่ไม่เคยดับ": "ผู้ถือแสง",
        "อิสรภาพ": "ผู้ถือแสง",
        "โลกที่เต็มไปด้วยความฝัน": "ผู้ถือแสง",
        "เธอยังกลัวบางสิ่ง": "ผู้ถือแสง",
        "ฉันในแบบที่ฉันเป็น": "ผู้ถือแสง",
        "เธอแข็งแกร่งกว่าที่คิด": "ผู้ถือแสง", # เสริมความเชื่อมั่น
    }
    ...
    image_filename = f"{personality}.jpg"  # สร้างชื่อไฟล์จากบุคลิก
    image_path = image_filename  # ปรับพาธถ้ารูปอยู่ในโฟลเดอร์อื่น เช่น "images/{image_filename}"

    try:
        st.image(image_path, caption=f"ภาพแทนบุคลิกของ {personality}")
