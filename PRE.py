...
if st.session_state.step < len(journey) * 2:
    ...
    personality_descriptions = {
        "ผู้เฝ้าดู": "เป็นผู้ที่เข้าใจทุกสิ่งแต่ไม่จำเป็นต้องเข้าไปเปลี่ยนแปลง
        ฉลาด ลึกซึ้ง มองเห็นความเป็นไปของโลกอย่างลึกซึ้ง
        อาจเต็มไปด้วยความลึกลับ โดดเดี่ยว หรือมีหน้าที่ที่ต้องแบกรับ",
        "นักเดินทาง": "บุคคลที่ไม่ยึดติดกับสิ่งใด ออกเดินทางเพื่อค้นหาคำตอบ
        ชอบการผจญภัย การเปลี่ยนแปลง และการค้นพบตัวเอง
        อาจเป็นนักปรัชญา นักสำรวจ หรือผู้ที่ไม่หยุดนิ่งกับกรอบเดิม ๆ",
        "ผู้รังสรรค์": "มีพลังในการสร้างสรรค์ ไม่ว่าจะเป็นศิลปะ ไอเดีย หรือโลกทั้งใบ
        เปี่ยมไปด้วยจินตนาการ นวัตกรรม และการเปลี่ยนแปลง
        อาจมีความเป็นเทพเจ้า นักปฏิวัติ หรือศิลปินผู้เปลี่ยนแปลงโลก",
        "นักรบเงา": "นักรบที่ไม่ต้องการชื่อเสียง แต่ต่อสู้เพื่ออุดมการณ์หรือสิ่งสำคัญ
        แข็งแกร่ง เงียบขรึม มีจรรยาบรรณ และอยู่เหนือความกลัว
        อาจเป็นมือสังหาร ซามูไร นักรบเงาที่ไม่มีใครจารึกชื่อ แต่ทรงพลัง",
        "ผู้หลงลืม": "ตัวตนที่เคยยิ่งใหญ่แต่ถูกโลกละเลย หรือเป็นผู้ที่ลืมตัวเอง
        มีความเศร้า ความลึกซึ้ง และเรื่องราวที่ถูกกลืนหายไป
        อาจเป็นวิญญาณแห่งอดีต นักรบที่ถูกลืม หรือบุคคลที่กำลังตามหาตัวเอง",
        "ผู้ถือแสง": "ผู้ที่นำแสงสว่างให้แก่ผู้อื่น ไม่ว่าจะเป็นความจริง ปัญญา หรือแรงบันดาลใจ
        มีภารกิจที่ยิ่งใหญ่ เป็นผู้นำ หรือเป็นผู้ให้กำเนิดสิ่งใหม่
        อาจเป็นวีรบุรุษ นักปราชญ์ หรือผู้เสียสละเพื่อสิ่งที่ยิ่งใหญ่กว่า",
    }
